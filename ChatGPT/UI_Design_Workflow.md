...
## **Phase 4 — Component Creation (Canonical + Repeatable Elements)**
...
3. Set **direction**
   ...
   * Horizontal: navbars, buttons
   * Vertical: cards, lists
     
4. Set padding & spacing

   * Use consistent spacing (8px grid recommended)
     
5. Hug contents vs Fill container
...
1. **Add color only after layout is locked**
   ...
   * Use grayscale structure as base
   * Replace grays with:

     * Primary / Secondary / Background / Text colors
     * Optional: alert / success colors
 ...
 * Zoom out → check readability at a glance
💡 Do a **“Zoomed out check”** — can you scan the UI in 5 seconds and understand hierarchy?
💡 Key: You only tweak **color and polish after layout, hierarchy, components, and Auto Layout are solid**.
